...
class EditProfile extends Component {
  ...
  toggleSocialInputs(e, prevState) {
    console.log(prevState.displaySocialInputs);
  ...
  onSubmit(e, state, history) {
    ...
    e.preventDefault();
    this.props.createProfile(formData, history, true);
  }
      ...
      <Fragment>
        <section className="container">
          ...
          >
            ...
            <div className="my-2">
              <button
                onClick={(e) => this.toggleSocialInputs(e, this.state)}
                type="button"
